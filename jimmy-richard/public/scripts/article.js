...
Article.prototype.insertRecord = function(callback) {
  $.post('/articles', {author: this.author, authorUrl: this.authorUrl, body: this.body, category: this.category, publishedOn: this.publishedOn, title: this.title})
    .then(data => {
      ...
      // This line is checking for a callback function and running it if there is one. When this method is called, if there is a callback function declared in the parameter then the callback will be invoked. Otherwise, if there isn't a callback put into the parameter the callback won't be invoked.
